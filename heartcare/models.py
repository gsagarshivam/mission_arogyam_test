...
class Blog(models.Model):
    ...
    image = models.ImageField(upload_to='static/heartcare/blog', default="")
...
class FilesAdmin(models.Model):
    ...
    adminfile = models.FileField(upload_to='media/heartcare/pdf', default="")
    image = models.ImageField(upload_to='static/heartcare/pdf', default="")
    def __str__(self):
        return self.title 
...
class Disease(models.Model):
    ...
    image = models.ImageField(upload_to='static/heartcare/disease', default="")
...
class Event(models.Model):
    ...
    desc = models.TextField(default="")
    pub_date = models.DateField()
    image = models.ImageField(upload_to='static/heartcare/event', default="")
...
class Slider(models.Model):
    ...
    pub_date = models.DateField()
    image = models.ImageField(upload_to='static/heartcare/slider', default="")
