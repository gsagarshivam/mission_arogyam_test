...
class Disease(models.Model):
    ...
    image = models.ImageField(upload_to='static/cancercare/disease', default="")
...
class Event(models.Model):
    ...
    desc = models.TextField(default="")
    pub_date = models.DateField()
    image = models.ImageField(upload_to='static/cancercare/event', default="")
...
class Slider(models.Model):
    ...
    pub_date = models.DateField()
    image = models.ImageField(upload_to='static/cancercare/slider', default="")
